...
influencer <- function(model, data, plot = "none") {
  ...
  for (i in 1:nrow(data)){
    cooks_label[i] <- ifelse(cooks_distance[i] >= cooks_cut, i, NA)
  }
  ...
  abline(h = cooks_cut, col = "red", lty = 2)
  text(1:length(cooks_label), 
       cooks_distance, labels = cooks_label, pos = 3, cex = 0.8, col = "blue")
...
# Cook's Distance with labels
alpha <- 0.05
df1 <- p       # Degrees of freedom for the numerator (number of parameters)
df2 <- 100000000 - p   # Degrees of freedom for the denominator (number of observations - number of parameters)
qf(0.5, df1, df2)

# Plot Cook's Distance
plot(cooks_d, type = "h", 
     main = "Cook's Distance", 
     ylab = "Cook's Distance", xlab = "Observation", col = "blue",
     ylim = c(0,1))
abline(h = F_critical, col = "red", lty = 2)  # Add F-critical value line

# DFFITS with labels
plot(dffits, type = "h", main = "DFFITS", ylab = "DFFITS", xlab = "Observation", col = "green")
abline(h = 2 * sqrt(p/n), col = "red", lty = 2)
text(1:length(dffits), dffits, labels = round(dffits, 2), pos = 3, cex = 0.8, col = "green")

# Hadi's Measure with labels
plot(Hadi_influence, type = "h", main = "Hadi's Influence Measure", ylab = "Hadi's Measure", xlab = "Observation", col = "purple")
abline(h = 2, col = "red", lty = 2)
text(1:length(Hadi_influence), Hadi_influence, labels = round(Hadi_influence, 2), pos = 3, cex = 0.8, col = "purple")
